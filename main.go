...
import (
	"database/sql"
	"encoding/json"
	"github/gapichardo/GolangNorthwindRestApi/database"
	"net/http"
...
// Product - Estructura de productos para utilizar
type Product struct {
	ID           int    `json:"id"`
...
// DeleteProducto - funcion para borrar productos
...
// UpdateProducto - actualizaci{on de productos}
